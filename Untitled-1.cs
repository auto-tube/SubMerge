...
namespace AutoTubeWpf.Services
{
    ...
    public class PollyTtsService : ITtsService, IDisposable
    {
        ...
        private bool _isPollyConfigured = false;

        public bool IsAvailable => this._isPollyConfigured && this._pollyClient != null;
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                // IsAvailable check at the start ensures _pollyClient is not null here
                SynthesizeSpeechResponse response = await this._pollyClient.SynthesizeSpeechAsync(request, cancellationToken);
